    ...
    return (
        <>
            ...
            <div className="space-y-6 animate-fade-in">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-4 bg-surface-800 border border-surface-600/50 rounded-xl p-4">
                    <div>
                        ...
                        <table className="w-full">
                            ...
                            <tbody>
                                {settlements.map((settlement) => (
                                    <tr key={settlement.id} className="border-b border-surface-600/20">
