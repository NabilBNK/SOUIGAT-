    ...
    return (
        <div className="min-h-screen bg-surface-900 flex items-center justify-center p-4">
            <div className="text-center animate-fade-in">
                ...
                <Link
                    to="/"
                    className="px-4 py-2.5 bg-brand-500 hover:bg-brand-600 text-white text-sm font-semibold rounded-md transition-colors"
                >
                    Retour à l'accueil
                </Link>
            </div>
...
export function Unauthorized() {
    return (
        <div className="flex items-center justify-center py-20">
            <div className="text-center animate-fade-in">
                <ShieldAlert className="w-16 h-16 mx-auto text-status-error/50 mb-4" />
