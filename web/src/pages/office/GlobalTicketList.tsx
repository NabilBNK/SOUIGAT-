...
const columns = [
    ...
    columnHelper.accessor('status', {
        ...
        cell: info => {
            ...
            return (
                <span className={`px-2 py-0.5 rounded text-xs font-medium border ${isCancelled ? 'bg-status-error/10 text-status-error border-status-error/20' : 'bg-status-success/10 text-status-success border-status-success/20'}`}>
