...
def _build_trip_payload(trip: Trip) -> Dict[str, Any]:
    ...
    return {
        ...
        'id': trip.id,
        'status': trip.status,
        'route_template_id': trip.route_template_id,
        'route_template_name': trip.route_template.name if trip.route_template_id and trip.route_template else '',
        'route_stop_snapshot': trip.route_stop_snapshot or [],
        'route_segment_tariff_snapshot': trip.route_segment_tariff_snapshot or [],
...
def _build_passenger_ticket_payload(ticket: PassengerTicket) -> Dict[str, Any]:
    ...
    return {
        ...
        'alighting_point': ticket.alighting_point,
