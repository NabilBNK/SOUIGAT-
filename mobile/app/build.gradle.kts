...
// Load keystore properties if available (gitignored — see keystore.properties.template)
...
android {
    ...
    defaultConfig {
        applicationId = "com.souigat.mobile"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0.0"
...
dependencies {
    ...
    // Hilt — compile-time DI (no runtime crashes in the field)
    ...
    // EncryptedSharedPreferences — JWT + device UUID storage
    implementation(libs.encrypted.shared.preferences)

    // Coil 3 — image loading
    implementation(libs.coil.compose)

    // Timber — debug logging (stripped in release via ProGuard)
    implementation(libs.timber)

    // Firebase — crash reporting (field visibility)
